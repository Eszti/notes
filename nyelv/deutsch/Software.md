...
| Verallgemeinerung                        | wir uns in andere Personen hineinversetzen sal                                                      |
| Unwägbarkeit: kivánnithetateansaig       | abdingbar elhagyhald                                                                                |
| Canern lesben all                        | Abhilfe onuosicis                                                                                   |
| Segitség                                 | Herangehensweise                                                                                    |
| handhabbar: kerelhető                    | erbringen: eredményes                                                                               |
| änderungsbedürftige Teile                | verpönt sain megtictatt                                                                             |
| Beeinträchtigung befayas das             | spendieren: adomanjar                                                                               |
| Top-down Betrachtungen: megremlicis      | beträchtlich jelentes"                                                                              |
| Gepflogenheiten: secka’s                 | sämtlich: valamennyi                                                                                |
| Sprechende Namen                         | Ausgangspunkt                                                                                       |
| zeitversetat                             | crisaugen                                                                                           |
| Untergliederung Julentas                 | infiltrieren: besivarog                                                                             |
| verteilt voneinander                     | im Hinblick auf                                                                                     |
